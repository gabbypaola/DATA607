...
Loading the HTML and JSON files were quick and painless, with the exception of the XML file which I was able to get help from a colleague, Ratihish P. on Slack.
```{r message=FALSE, warning=FALSE}
#load HTML as df
...
#load xml file as df
xml_file <- read_file("https://raw.githubusercontent.com/gabbypaola/DATA-607/main/XMLTABLE9.xml")
